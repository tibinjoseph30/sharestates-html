...
$(document).ready(function(){
	...
	var myDataTable =  $('#flood-table-list').DataTable({
        "dom": '<<t>p>',
        "aLengthMenu":false,
        "paging":   true,
        "bLengthChange": true,
        ...
        "ajax": {
            "url": base_url+'backend/manage_insurance/ajax_flood_list',
            "type": "GET",
            "data": function(d){
    ...
    //----------------------filter options --------------------
    oTable = $('#flood-table-list').dataTable();
        ...
        if(form_valid == true){
            $.post(base_url+'backend/manage_insurance/change_status',$("#insurance-inactive-form").serialize(),function(response){
                ...
                if(response.status == true){
                    ...
                    $('#flood-table-list').DataTable().ajax.reload();
    ...
    $(document).on('click','.app-activate',function(){
        var appr_id = $(this).attr('data-id');
        var type = $(this).attr('data-type');
        status_update({'status':type,'insurance_id':appr_id,'csrf_test_name':global_csrf_token_value},base_url+'backend/manage_insurance/change_status',"Do you really want to change status of this insurance?","Insurance status updated successfully.","Insurance status is could not be updated",'flood-table-list');
    });
    ...
    $(document).on('click','.unblock-user',function(){
        var appr_id = $(this).attr('data-id');
        var type = $(this).attr('data-type');
        status_update({'status':type,'insurance_id':appr_id,'csrf_test_name':global_csrf_token_value},base_url+'backend/manage_insurance/change_block_status',"Do you really want to unblock this insurance?","Insurance Unblocked Successfully.","Insurance could not be unblocked",'flood-table-list');
