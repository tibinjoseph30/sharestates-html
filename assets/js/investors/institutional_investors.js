...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if(response.status == true){
                $("#total_institutional_investors").html(response.total_institutional_investors['total']);
                ...
                $("#total_active_institutional_investors").html(response.total_active_institutional_investors['total']);
                ...
                $("#total_inactive_institutional_investors").html(response.total_inactive_institutional_investors['total']);
	...
	var myDataTable =  $('#investorList').DataTable({
        ...
        "ajax": {
            "url": base_url+'backend/investors/ajax_institutional_investors_list',
            "type": "GET",
            "data": function(d){
    ...
    var myDataTable =  $('#investorList_NA').DataTable({
        ...
        //"ajax": window.location.href,
        "ajax": {
            "url": base_url+'backend/investors/ajax_institutional_investors_list_NA',
            "type": "GET",
            "data": function(d){
    ...
    $(document).on('click','#non_accredited',function(){
        ...
        $.ajax({
            type: 'POST',
            data: post_data,
            url:  base_url+'backend/investors/get_na_institutional_count_amt',
            success: function (result) {
                var response = $.parseJSON(result); 
                if(response.status == true){
                    $("#total_institutional_investors_na").html(response.total_institutional_investors_na['total']);
                    ...
                    $("#total_active_institutional_investors_na").html(response.total_active_institutional_investors_na['total']);
                    $("#institutional_active_invest_total_na").html('$'+response.total_active_institutional_invest_na['display_amount']+response.total_active_institutional_invest_na['display_label_first']);

                    $("#total_inactive_institutional_investors_na").html(response.total_inactive_institutional_investors_na['total']);
                    $("#institutional_inactive_invest_total_na").html('$'+response.total_inactive_institutional_invest_na['display_amount']+response.total_inactive_institutional_invest_na['display_label_first']);
                }
    ...
    $('#download_accredited').on('click',function(){
        ...
        window.location.href = base_url + "backend/investors/export_institutional?search="+search+"&date_range="+date_range+"&from_date="+from_date+"&to_date="+to_date;
    });
    ...
    $('#download_nonaccredited').on('click',function(){
        ...
        window.location.href = base_url + "backend/investors/export_institutional_na?search="+search_na+"&date_range="+date_range_na+"&from_date="+from_date_na+"&to_date="+to_date_na;
    });
