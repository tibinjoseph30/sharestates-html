...
if(tab_type == 'bridge'){
    var jason_calender_url = 'admin_template/assets/json/sales_calender_sc.json';
    ...
    var jason_calender_url = 'admin_template/assets/json/sales_term_calender_sc.json';
...
$(document).ready(function(){
    ...
    $("#eventCalendarDefault").eventCalendar({
        eventsjson: base_url + 'admin_template/assets/json/sales_calender_sc.json',
    });

    $("#eventCalendarDefault_term").eventCalendar1({
        eventsjson: base_url + 'admin_template/assets/json/sales_term_calender_sc.json',
    });
...
$("#total_unsold_loans").click(function(){
    ShwLoadingPanel();
    $.getJSON(base_url+'admin_template/assets/json/sales_calender_sc.json', function(data) {
        var html = '';
...
$("#term_total_unsold_loans").click(function(){
    ShwLoadingPanel();
    $.getJSON(base_url+'admin_template/assets/json/sales_term_calender_sc.json', function(data) {
        var html = '';
        $.each(data, function(key, event) {
            html +='<tr><td>'+event.title+'</td><td>'+event.pclose_date+'</td><td>'+event.days_elapsed+'</td><td>$'+number_format(event.loanamt, 2)+'</td><td>'+event.plan_popup+'</td></tr>';
