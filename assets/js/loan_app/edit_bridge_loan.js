...
$(document).ready(function(){
	...
	/*$(document).on('click','#ctn-btn1',function(e){
		...
		if($('#transaction-form').valid() == true){
    		...
    		//var shareline_details = $("#shareline-form").serialize();
    		...
    		if($("#refinance-CEMA").prop('checked') == true && $('#property_state').val()!=5 ){
	    		...
	    		$.post(base_url+'backend/quick_loans/update_quik_loan_data',new_form,function(data){
	...
	$(document).on('click','.bridge-loan-update',function(e){
